...
{{-- 
            ...
            <div class="d-grid gap-2 col-6 mx-auto mt-5">
              {{-- <button class="btn btn-warning" type="button" style="border-radius: 8px;">Konfirmasi Pembayaran</button> --}}
              <a href="{{url('/pemilik-kos/booking/menerimaPembayaran/'. $datas[0]->Id_pemesanan)}}" class="btn btn-warning justify-content-center" type="button" style="border-radius: 8px;">Konfirmasi Pembayaran</a>
