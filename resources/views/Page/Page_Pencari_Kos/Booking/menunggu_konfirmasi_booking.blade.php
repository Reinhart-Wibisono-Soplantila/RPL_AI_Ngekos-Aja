...
@push('time')
      ...
      <p id="demo2"></p> --}}
  {{-- <script>
    var dateStart = "{{ $datas[0]->Jam_konfimasi_mulai}}";
    var dateFinish = "{{ $datas[0]->Jam_konfimasi_selesai}}";
    document.getElementById("demo").innerHTML = dateStart;
    document.getElementById("demo2").innerHTML = dateFinish;
  </script> --}}
@endpush
