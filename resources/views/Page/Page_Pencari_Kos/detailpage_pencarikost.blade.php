        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active " id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
                  {{-- <iframe src="{{asset('storage/'. $datas[0]->Foto_tampak_dalam)}}" width="100%" height="460" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> --}}
            ...
            <div class="d-grid gap-2 col-6 mx-auto mt-3">
              <a href="{{url('/pencari-kos/booking/'.$datas[0]->Id_kos)}}" class="btn btn-warning justify-content-center" type="button" style="border-radius: 8px">Booking Kos Sekarang!</a>
              <a href="{{url('https://api.whatsapp.com/send?phone='.$datas[0]->no_telepon.'&text=Halo,%20saya%20ingin%20memesan%20kos%20anda')}}" class="btn btn-outline-warning justify-content-center mt-3" type="button" style="border-radius: 8px">Chat Dengan Pemilik Kos</a>
              <div class="d-grid gap-2 d-md-block text-center">
                <a href="{{url('/')}}" class="btn btn-outline-warning justify-content-center mt-5" type="button" style="border-radius: 8px">Kembali ke beranda</a>
              </div>
            </div>
