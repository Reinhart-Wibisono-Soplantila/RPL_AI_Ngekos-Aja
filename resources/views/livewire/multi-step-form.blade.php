                ...
                <div id="form-total">
                        ...
                        <div class="inner">
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="Masukkan Nama Kos (Contoh: Kos Permata Hijau)" class="form-control" id="Nama_indekos" wire:model="Nama_indekos" value="{{old('Nama_indekos')}}">
                                    <span class="text-danger">@error('Nama_indekos')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Deskripsi_indekos')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="Contoh: Tipe kamar A/VVIP/Executive" class="form-control" id="roomtype" wire:model="Tipe_kamar" value="{{old('Tipe_kamar')}}">
                                    <span class="text-danger">@error('Tipe_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group-flex">
                                            <div class="form-radio">
                                                ...
                                                <div class="form-flex" wire:model="Gender_kamar">
                                                    ...
                                                    <label for="female"><img src="{{URL::asset('/assets/img/icon-female.png')}}" alt="Female"></label>
    
                                                    <input type="radio" name="gender" value="Campuran" id="mix" />
                                                    <label for="mix"><img src="{{URL::asset('/assets/img/icon-mix.png')}}" alt="mix"></label>
                                                </div>	
                                            </div>
                                            <span class="text-danger">@error('Gender_kamar')
                                                {{$message}}
                                            @enderror</span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <span class="text-danger">@error('Peraturan')
                                    {{$message}}
                                @enderror</span>
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <textarea placeholder="Masukkan Peraturan Kos Anda" class="form-control" id="desc-rules"  wire:model="Peraturan_lain" value="{{old('Peraturan_lain')}}"></textarea>
                                    <span class="text-danger">@error('Peraturan_lain')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    {{-- <div class="input-group date" id="datepicker"> --}}
                                        ...
                                        <input type="text" placeholder="Masukkan Tahun" class="form-control" id="year" wire:model="Tanggal_dibangun" value="{{old('Tanggal_dibangun')}}">
                                    ...
                                    {{-- </div> --}}
                                    <span class="text-danger">@error('Tanggal_dibangun')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            {{-- <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <textarea placeholder="Masukkan Catatan Anda" class="form-control" id="desc-notes1" name="desc-notes1" wire:model="Catatan_tambahan"></textarea>
                                </div>
                            </div> --}}
                        </div>
                        @endif
                        ...
                        <div class="inner">
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="Masukkan Alamat Kos" class="form-control" id="address" wire:model="Alamat" value="{{old('Alamat')}}">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="Masukkan Kabupaten/Kota" class="form-control" id="district" wire:model="Kabupaten_kota" value="{{old('Kabupaten_kota')}}">
                                    <span class="text-danger">@error('Kabupaten_kota')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="Masukkan Kecamatan" class="form-control" id="subdistrict" wire:model="Kecamatan" value="{{old('Kecamatan')}}">
                                    <span class="text-danger">@error('Kecamatan')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                    ...
                    <section>
						...
						<div class="container">
							...
							<div class="mb-3">
                                {{-- @if ($Foto_tampak_depan)
                                    <img src="{{$Foto_tampak_depan->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                ...
                                <span class="text-danger">@error('Foto_tampak_depan')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>	
						<div class="container">
							...
							<div class="mb-3">
                                {{-- <img class="img-preview_dalam_bangunan img-fluid col-sm-4"> --}}
                                {{-- @if ($Foto_tampak_dalam)
                                    <img src="{{$Foto_tampak_dalam->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                ...
                                <span class="text-danger">@error('Foto_tampak_dalam')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
						<div class="container">
							...
							<div class="mb-3">
                                {{-- @if ($Foto_dari_jalan)
                                    <img src="{{$Foto_dari_jalan->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                {{-- <img class="img-preview_dari_jalan img-fluid col-sm-4"> --}}
                                ...
                                <span class="text-danger">@error('Foto_dari_jalan')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
                    ...
                    <section>
						...
						<div class="container">
							...
							<div class="mb-3">
                                {{-- <img class="img-preview_depan_kamar img-fluid col-sm-4"> --}}
                                {{-- @if ($Foto_depan_kamar)
                                    <img src="{{$Foto_depan_kamar->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                ...
                                <span class="text-danger">@error('Foto_depan_kamar')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
						<div class="container">
							...
							<div class="mb-3">
                                {{-- @if ($Foto_dalam_kamar)
                                    <img src="{{$Foto_dalam_kamar->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                {{-- <img class="img-preview_dalam_kamar img-fluid col-sm-4"> --}}
                                ...
                                <span class="text-danger">@error('Foto_dalam_kamar')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
						<div class="container">
							...
							<div class="mb-3">
                                {{-- @if ($Foto_kamar_mandi)
                                    <img src="{{$Foto_kamar_mandi->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                {{-- <img class="img-preview_kamar_mandi img-fluid col-sm-4"> --}}
                                ...
                                <span class="text-danger">@error('Foto_kamar_mandi')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
						<div class="container">
							...
							<div class="mb-3">
                                {{-- @if ($Foto_lainnya)
                                    <img src="{{$Foto_lainnya->temporaryUrl()}}" class="img-fluid" style="height: 200px"></img>
                                @endif --}}
                                {{-- <img class="img-preview_lainnya img-fluid col-sm-4"> --}}
                                ...
                                <span class="text-danger">@error('Foto_lainnya')
                                    {{$message}}
                                @enderror</span>
                            </div>
						</div>
                        ...
                        <div class="inner">
                            <div class="form-row">
                                <div class="title-checkbox">
                                    ...
                                    <span class="text-danger">@error('Fasilitas_umum')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <span class="text-danger">@error('Fasilitas_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <span class="text-danger">@error('Fasilitas_kamar_mandi')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                                <div class="form-row">
                        ...
                        <div class="inner">
                            <div class="form-row">
                                <div class="form-holder">
                                    ...
                                    <span class="text-danger">@error('Panjang_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-holder">
                                    <input type="text" placeholder="Lebar (m)" class="form-control" id="Lebar_kamar" name="Lebar_kamar" wire:model="Lebar_kamar" value="{{old('Lebar_kamar')}}">
                                    <span class="text-danger">@error('Lebar_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Jumlah_seluruh_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Jumlah_ketersediaan_kamar')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                        ...
                        <div class="inner">
                            {{-- <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Harga_sewa')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div> --}}
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    <label for="card-type">Jangka waktu minimum untuk bisa menyewa kamar kos Anda.</label>
                                        ...
                                        <span class="text-danger">@error('Jangka_waktu_sewa')
                                            {{$message}}
                                        @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Harga_sewa_pertahun')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Harga_sewa_per6bulan')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Harga_sewa_per3bulan')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <span class="text-danger">@error('Harga_sewa_perbulan')
                                        {{$message}}
                                    @enderror</span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    <label for="card-type">Terapkan Uang Muka?</label>
                                        ...
                                        <span class="text-danger">@error('Uang_muka')
                                            {{$message}}
                                        @enderror</span>
                                </div>
                            </div>
