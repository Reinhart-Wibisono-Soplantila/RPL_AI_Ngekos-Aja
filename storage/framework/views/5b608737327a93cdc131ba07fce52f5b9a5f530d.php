        ...
        <div class="kolom mt-3 ms-5 me-5 justify-content-evenly">
          <!-- Biodata Penyewa -->
            ...
            <div class="d-grid gap-2 col-6 mx-auto mt-5">
              <a href="<?php echo e(url('/pemilik-kos/booking/menerima/'. $datas[0]->Id_pemesanan)); ?>" class="btn btn-warning justify-content-center" type="submit" style="border-radius: 8px;">Terima</a>
              <a href="<?php echo e(url('/pemilik-kos/booking/menolak/'. $datas[0]->Id_pemesanan)); ?>" class="btn btn-outline-warning justify-content-center" type="submit" style="border-radius: 8px;">Tolak</a>
            </div>
          </div>
        </div>
      </div>
