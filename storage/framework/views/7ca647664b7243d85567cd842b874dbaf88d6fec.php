                    ...
                    <div class="inner">
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Masukkan Nama Kos (Contoh: Kos Permata Hijau)" class="form-control" name="Nama_indekos" id="Nama_indekos" wire:model="Nama_indekos" value="<?php echo e(old('Nama_indekos')); ?>">
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Nama_indekos'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Deskripsi_indekos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Contoh: Tipe kamar A/VVIP/Executive" class="form-control" id="roomtype" name="roomtype" wire:model="Tipe_kamar" value="<?php echo e(old('Tipe_kamar')); ?>">
                                <span class="text-danger">
                                    ...
                                    <div class="form-group-flex">
                                        <div class="form-radio">
                                            ...
                                            <div class="form-flex" wire:model="Gender_kamar">
                                                ...
                                                <label for="female"><img src="<?php echo e(URL::asset('/assets/img/icon-female.png')); ?>"></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <textarea placeholder="Masukkan Peraturan Kos Anda" class="form-control" id="desc-rules" name="desc-rules" wire:model="Peraturan_lain" value="<?php echo e(old('Peraturan_lain')); ?>"></textarea>
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Peraturan_lain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Masukkan Tahun" class="form-control" id="year" name="year" wire:model="Tanggal_dibangun" value="<?php echo e(old('Tanggal_dibangun')); ?>">
                                <span class="text-danger">
                    ...
                    <div class="inner">
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Masukkan Alamat Kos" class="form-control" id="address" name="address" wire:model="Alamat" value="<?php echo e(old('Alamat')); ?>">
                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Masukkan Kabupaten/Kota" class="form-control" id="district" name="district" wire:model="Kabupaten_kota" value="<?php echo e(old('Kabupaten_kota')); ?>">
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Kabupaten_kota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Masukkan Kecamatan" class="form-control" id="subdistrict" name="subdistrict" wire:model="Kecamatan" value="<?php echo e(old('Kecamatan')); ?>">
                                <span class="text-danger">
                ...
                <section>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($datas[0]['Foto_tampak_depan']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_tampak_depan'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_tampak_depan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_tampak_dalam']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_tampak_dalam'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_tampak_dalam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_dari_jalan']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_dari_jalan'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_dari_jalan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <section>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_depan_kamar']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_depan_kamar'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_depan_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_tampak_dalam']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_dalam_kamar'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_dalam_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_kamar_mandi']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_kamar_mandi'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                            ...
                            <span class="text-danger">
                                <?php $__errorArgs = ['Foto_kamar_mandi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <?php if($datas[0]['Foto_lainnya']): ?>
                                <img src="<?php echo e(asset('storage/'. $datas[0]['Foto_lainnya'])); ?>" class="img-preview img-fluid" style="height: 200px">
                            <?php endif; ?>
                    ...
                    <div class="inner">
                        <div class="form-row">
                            <div class="title-checkbox">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Fasilitas_umum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="title-checkbox">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Fasilitas_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="title-checkbox">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Fasilitas_kamar_mandi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder">
                                <input type="text" placeholder="Lebar (m)" class="form-control" id="width" name="width" id="Lebar_kamar" name="Lebar_kamar" wire:model="Lebar_kamar" value="<?php echo e(old('Lebar_kamar')); ?>">
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Lebar_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Jumlah_seluruh_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Jumlah_ketersediaan_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                <label for="card-type">Jangka waktu minimum untuk bisa menyewa kamar kos Anda.</label>
                                    ...
                                    <span class="text-danger">
                                        <?php $__errorArgs = ['Jangka_waktu_sewa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Harga_sewa_pertahun'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Harga_sewa_per6bulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Harga_sewa_per3bulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2">
                                ...
                                <span class="text-danger">
                                    <?php $__errorArgs = ['Harga_sewa_perbulan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\Users\Reinhart Soplantila\Documents\Project\TI\laravell\ngekos-aja-2\resources\views/livewire/update-multi-form.blade.php ENDPATH**/ ?>