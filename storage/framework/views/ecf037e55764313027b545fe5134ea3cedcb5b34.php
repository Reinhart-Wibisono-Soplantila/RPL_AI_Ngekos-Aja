            ...
            <div class="kolom mt-3 ms-5 me-5 justify-content-evenly"><hr>
                  ...
                  <div class="row justify-content-between pt-5">
                    <div class="col-4 shadow p-3" style="border-radius: 8px;">
                      ...
                      <a href="/pemilik-kos/profile/edit/<?php echo e(auth()->user()->UserId); ?>" class="btn btn-warning justify-content-center" type="button" style="border-radius: 8px">Edit Profil</a>
                    </div>
        
                    <div class="col-4 shadow p-3" style="border-radius: 8px;">
                      <h6 class="fw-bolder">Hapus Akun</h6>
                      <p>Anda dapat menghapus akun Anda secara permanen</p><br>
                      <form action="/pemilik-kos/profile/<?php echo e(auth()->user()->UserId); ?>" method="POST">
