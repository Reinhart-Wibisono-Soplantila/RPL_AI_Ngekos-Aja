                  ...
                  <ul class="navbar-nav ms-auto" style="width: 100%">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li>
                          <a class="dropdown-item" href="<?php echo e(url('/pemilik-kos/profile/')); ?>">Profile</a>
                        </li>
                        <li>
            ...
            <!-- End Header/Navbar --><?php /**PATH C:\Users\Reinhart Soplantila\Documents\Project\TI\laravell\ngekos-aja-2\resources\views/Include/pemilik_kos/navbar.blade.php ENDPATH**/ ?>